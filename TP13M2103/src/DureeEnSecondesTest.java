...
public class DureeEnSecondesTest {
	
	private Duree h1;

	@Before
	public void setUp() throws Exception {
		this.h1 = new DureeEnSecondes(1,2,3);
	}
	...
	public void testMinutesSuperieur59() {
		this.h1 = new DureeEnSecondes(1,65,3);
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testSecondesNegative() {
		this.h1 = new DureeEnSecondes(1,5,-9);
	}

	@Test(expected = IllegalArgumentException.class)
	public void testSecondesSuperieur59() {
		this.h1 = new DureeEnSecondes(1,5,65);
	}
	
	@Test
	public void testEqualsValeursEgales() {
		Duree h2 = new DureeEnSecondes(1,2,3);
		assertEquals(h1,h2);
	}
	
	@Test
	public void testEqualsValeursNonEgales() {
		Duree h2 = new DureeEnSecondes(0,2,3);
		assertNotEquals(h2,h1);
		Duree h3 = new DureeEnSecondes(1,0,3);
		assertNotEquals(h3,h1);
		Duree h4 = new DureeEnSecondes(1,2,0);
	...
	public void testAjouterUneSeconde() {
		...
		Duree h2 = new DureeEnSecondes(0,2,59);
		h2.ajouterUneSeconde();
		assertEquals(3,h2.getMinutes());
		Duree h3 = new DureeEnSecondes(1,59,59);
	...
	public void testCompareTo() {
		assertEquals(0, ((DureeEnSecondes) h1).compareTo(new DureeEnSecondes(1,2,3)));
		assertTrue(((DureeEnSecondes) h1).compareTo(new DureeEnSecondes(1,2,1)) > 0);
		assertTrue(((DureeEnSecondes) h1).compareTo(new DureeEnSecondes(1,3,2)) < 0);
